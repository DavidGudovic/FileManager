            ...
            <MenuItems
                ...
                <div class="px-1 py-1">
                    <MenuItem v-slot="{ active }">
                        <a class="cursor-pointer text-gray-700 block px-4 py-2 text-sm hover:text-indigo-500">New Folder</a>
                    </MenuItem>
                </div>

                <div class="px-1 py-1">
                    <MenuItem v-slot="{ active }">
                        <a class="cursor-pointer text-gray-700 block px-4 py-2 text-sm hover:text-indigo-500">Upload Files</a>
                    </MenuItem>

                    <MenuItem v-slot="{ active }">
                        <a class="cursor-pointer text-gray-700 block px-4 py-2 text-sm hover:text-indigo-500">Upload Folder</a>
                    </MenuItem>
                </div>
            </MenuItems>
        </transition>
